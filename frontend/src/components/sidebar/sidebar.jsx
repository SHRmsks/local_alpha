    ...
    <>
      <div
        className={`flex flex-col space-y-5 ${
          isCollapsed ? "invisible w-0" : "visible min-w-[160px]"
        }`}
      >
        <div className="bg-[#FFFEFA] flex flex-col items-center gap-2 rounded-lg shadow-md pt-5 pb-4 px-4">
          <button
            ...
            className="ml-auto bg-gray-400 rounded-[25%]"
          >
            <Image
              src={BackArrowIcon}
              width={12}
        ...
        >
          <div className="flex">
            <Image src={PostsIcon} width={20} height={20} alt="Posts Icon" />
            <a href="#" className="ml-2">
              POSTS
            </a>
          </div>
          <div className="flex">
            <Image src={BuyIcon} width={20} height={20} alt="Buy Icon" />
            <a href="#" className="ml-2">
              BUY
            </a>
          </div>
          ...
          <div className="flex">
            <Image src={PenIcon} width={20} height={20} alt="Create Icon" />
            <a href="#" className="ml-2">
              CREATE
            </a>
          </div>
      ...
      <div
        className={`${
          isCollapsed ? "visible mr-auto mt-10 " : "invisible w-0 h-0"
        }`}
      >
        <button
          onClick={() => setIsCollapsed((curr) => !curr)}
          className="absolute left-0 lg:w-[124px] md:w-[100px] w-[75px] bg-[#FFFEFA] p-3 rounded-r-[8px] shadow-md"
        >
          <Image
            src={Pic}
            width={100}
